...
//
//        String filePath = "D:\\Users\\zhubinsheng\\Documents\\GitHub\\jeecg-boot\\jeecg-boot\\jeecg-boot-module-demo\\src\\main\\java\\org\\jeecg\\modules\\pdf\\file";
//        byte[] fileData = sign("123456", filePath+"\\keystore.p12", //
//                filePath+"\\filled.pdf",//
//                filePath+"\\signImage.jpg", 250, 390);
//        FileOutputStream f = new FileOutputStream(new File(filePath+"\\signed.pdf"));
//        f.write(fileData);
//        f.close();
//    }
//}
