package org.jeecg.modules.block.controller;
...
public class BlockController extends JeecgController<Block, IBlockService> {
	...
	public Result<?> queryPageList(Block block,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<Block> queryWrapper = QueryGenerator.initQueryWrapper(block, req.getParameterMap());
		Page<Block> page = new Page<Block>(pageNo, pageSize);
		IPage<Block> pageList = blockService.page(page, queryWrapper);
	...
	public Result<?> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		this.blockService.removeByIds(Arrays.asList(ids.split(",")));
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Block block) {
        return super.exportXls(request, block, Block.class, "楼栋表");
    }
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, Block.class);
    }
