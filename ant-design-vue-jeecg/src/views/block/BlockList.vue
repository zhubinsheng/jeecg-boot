...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'associatedArea',text:'关联的区域',dictCode:''})
        fieldList.push({type:'string',value:'blockName',text:'楼栋名称',dictCode:''})
        fieldList.push({type:'string',value:'numberOfFloors',text:'楼层数',dictCode:''})
        fieldList.push({type:'string',value:'facility',text:'设施',dictCode:''})
