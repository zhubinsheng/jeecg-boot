...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'regionName',text:'区域名',dictCode:''})
        fieldList.push({type:'pca',value:'regionPlace',text:'区域名'})
        fieldList.push({type:'string',value:'facilities',text:'设施',dictCode:''})
